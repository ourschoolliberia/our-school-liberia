...
exports = module.exports = function(done) {
	...
	async.series([
		...
		async.times.bind(null, 20, iteratorFromPrototype('PressRelease', demoPressRelease, function(obj, key) {
			obj.title += ' ' + key;
			obj.dateReleased.setDate(key+1 % 30);
		})),
		async.times.bind(null, 20, iteratorFromPrototype('TeamMember', demoTeamMember, function(obj, key) {
